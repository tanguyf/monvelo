...
public class MarkerManager {
    ...
    private SparseArray<MarkerWrapper> normalMarkers = new SparseArray<>(20);
    private SparseArray<MarkerWrapper> midMarkers = new SparseArray<>(150);
    private SparseArray<MarkerWrapper> tinyMarkers = new SparseArray<>(600);
